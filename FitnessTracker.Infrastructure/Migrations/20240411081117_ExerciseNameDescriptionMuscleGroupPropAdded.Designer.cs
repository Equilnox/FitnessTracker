...
namespace FitnessTracker.Infrastructure.Migrations
{
    ...
    [Migration("20240411081117_ExerciseNameDescriptionMuscleGroupPropAdded")]
    partial class ExerciseNameDescriptionMuscleGroupPropAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessTracker.Infrastructure.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c8a7b85f-2f0d-4799-806b-884718877b8a",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFjNqq+Sq4T+/kKxmAbn1OqvZkRqhuzn0IesCZ4zq5jtdXJCagx5X18siV0J/kG83w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "3272e8c3-9994-4658-bef4-a8b00c3862cd",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c1184b62-799a-4419-99bc-6f0f0f122ab8",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEO0A1OWkX+JFf5me2FbW/QYy6f9Ew9Y+goe5yJhDBs4CBXkNbvdY2Pv9eEX0KcwTZw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e4821193-01d3-4d59-bfb9-31a25cd23024",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "95a907a8-2820-4e59-811b-90b27cc089f6",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEB/vkli+fN2mpENYQpiKPk5Dt2DySWWesm+A7kMGHBgRgTqkXhV+rElqpOQbxBH+5A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1e811348-bf99-4882-9c4f-33147740f372",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("FitnessTracker.Infrastructure.Data.Models.Exercise", b =>
                {
                    ...
                    b.Property<bool>("IsApproved")
                        .HasColumnType("bit")
                        .HasComment("A boolean check that represents if the Exercise is Approved by the admin. Default value is false. When value is set to true the Exercise is shown in the page.");

                    b.Property<int>("MuscleGroup")
                        .HasColumnType("int")
                        .HasComment("Exercise targeted muscle. Can be one of following: 0 = Compound move; 1 = Chest muscles; 2 = Back muscles; 3 = Legs muscles; 4 = Arms muscles; 5 = Abdominal muscles.");
            ...
            modelBuilder.Entity("FitnessTracker.Infrastructure.Data.Models.Gym", b =>
                {
                    ...
                    b.Property<int>("GymType")
                        .HasColumnType("int")
                        .HasComment("Gym type. Can be one of following: 0 = Personal; 1 = Public.");
                    ...
                    b.Property<string>("OwnerId")
                        ...
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)")
                        .HasComment("Gym owner Identifier.");
            ...
            modelBuilder.Entity("FitnessTracker.Infrastructure.Data.Models.Requests", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ChangeMuscleGroup")
                        .HasColumnType("int")
                        .HasComment("Property for changing exercise targeted muscle group");

                    b.Property<DateTime>("DateCreated")
                        .HasColumnType("datetime2")
                        .HasComment("The date the request was made. Default value is 'DateTime.Now'");

                    b.Property<DateTime?>("DateDone")
                        .HasColumnType("datetime2")
                        .HasComment("The date the request was processed");

                    b.Property<string>("ExerciseDescription")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasComment("Property for current exercise description");
                    ...
                    b.Property<string>("ExerciseName")
                        ...
                        .HasMaxLength(25)
                        .HasColumnType("nvarchar(25)")
                        .HasComment("Property for current exercise name");

                    b.Property<string>("ExerciseNewDescription")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasComment("Property for Changing Exercise Description");

                    b.Property<string>("ExerciseNewName")
                        .IsRequired()
                        .HasMaxLength(25)
                        .HasColumnType("nvarchar(25)")
                        .HasComment("Property for Changing Exercise Name");

                    b.Property<string>("MuscleGroupe")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasComment("Property for current exercise muscle group");

                    b.Property<string>("RequestStatus")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasComment("Request status. Can be Pending = 0 or Done = 1");

                    b.Property<string>("RequestType")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasComment("Type of request. Can be Add Exercise = 0, Edit Exercise = 1");
            ...
            modelBuilder.Entity("FitnessTracker.Infrastructure.Data.Models.Athlete", b =>
                {
                    b.HasOne("FitnessTracker.Infrastructure.Data.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("FitnessTracker.Infrastructure.Data.Models.Gym", b =>
                {
                    b.HasOne("FitnessTracker.Infrastructure.Data.Models.ApplicationUser", "Owner")
                        .WithOne()
                        .HasForeignKey("FitnessTracker.Infrastructure.Data.Models.Gym", "OwnerId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FitnessTracker.Infrastructure.Data.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
